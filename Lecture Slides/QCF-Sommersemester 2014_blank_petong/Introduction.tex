...
%
	...
	<1-> Sea levels will rise and low-lying land such as Tarawa, Kiribati will be at risk
%

	<2-> Hunger will increase, but more slowly
%

	<3-> Northern areas such as Canada and northern Europe will become more agriculturally productive
%

	<4-> Substantial increase in 'extreme weather events': more droughts, more heatwaves, more floods and more intense storms
%% end itemize
%\end{frame} %Source: McKinsey & Co (2004(?))
