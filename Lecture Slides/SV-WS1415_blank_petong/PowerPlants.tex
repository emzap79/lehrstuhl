...
%% Hier Strom alleine
\frame{\frametitle{Phelix Base 2002-12}
\begin{figure}[htp]
\centering
...
\frame{\frametitle{Value lost -- back on the envelope calculations}
\begin{itemize}
...
\frame{\frametitle{Clean Spark Spreads}
\begin{itemize}
...
\frame{\frametitle{Valuation of Simple Spread Options}
...
\frame{\frametitle{Approximation by Kirk's Formula (2 Assets)}
...
\frame{\frametitle{Approximation for three asset case}
\begin{itemize}
...
\frame{\frametitle{Real Option Approach}
\begin{itemize}
...
\frame{\frametitle{Real Option Approach -- Forward Based}
\begin{itemize}
...
\frame{\frametitle{Heath-Jarrow-Morton (HJM) Approach}
...
\frame{\frametitle{Factor GBM Specification}
\begin{itemize}
...
\frame{\frametitle{Volatility Functions}
...
\frame{\frametitle{Forward Schwartz Volatility}
\begin{itemize}
...
\frame{\frametitle{Swap Schwartz Volatility}
...
\frame{ \frametitle{A Two-Factor Model}
\begin{itemize}
...
\begin{frame}
\frametitle{Parameter-risk implied bid-ask spread w.r.t. correlation parameter, Gaussian jumps.}
\begin{columns}[t]
...
\begin{frame}
\frametitle{Parameter-risk implied bid-ask spread w.r.t. the gas price process, Gaussian jumps.}
\begin{columns}[t]
\begin{column}[l]{0.6\textwidth}
...
\frame{\frametitle{Estimation Procedures: Emissions and Gas}
\begin{itemize}
...
\frame{\frametitle{Estimation Procedures: Power I}
...
\frame{\frametitle{Estimation Procedures: Power II}
\begin{itemize}
