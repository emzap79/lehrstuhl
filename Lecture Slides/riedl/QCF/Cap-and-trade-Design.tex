...
\end{frame}
  ...
  % March Allocation of allowances for the current year (in advance)
  %January Compliance time, i.e. pollutors have to deliver allowances for the last year to the regulator
  \item<2-> The amount of the excess emissions penalty in the upcoming third phase shall be indexed to the annual inflation rate of the Eurozone.  %Source: DB Research 2011, CMA 2011
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{Allocation and emissions in the EU ETS}
\begin{center}
\begin{figure}[h!]
\centering
\rotatebox{0}{
...
\end{figure}
\end{center}
\end{frame} %Source: Climate Strategies (2011)

\subsection{ETS and Flexibility}
\frame{\frametitle{ETS and flexibility: {\it When} and {\it Where}}
\begin{center}
\begin{figure}[h!]
\centering
...
\begin{frame}
  \frametitle{Permit price in the EU ETS during the first phases}
\begin{center}
\begin{figure}[h!]
\centering
\rotatebox{0}{
...
\end{figure}
\end{center}
\end{frame} %Source: EEA_GHGtrendsprojections
...
\frame{\frametitle{Financial Impact}
Financial impact relates to how consumers in a country with a regulation policy are affected in monetary terms.
\begin{itemize}
\item<1-> In emission trading systems with free allocation companies have integrated the costs (price) for certificates as real costs and prices have increased (pass-through rates of cost between 60\% and 100\% in Germany).
\item<2-> High windfall profits for companies in the power sector (around 5 Mrd Euro).
\item<3-> Tax systems will also increase costumer costs.
\end{itemize}
}
...
Mitigation costs rise because more expensive technologies in countries with tax would substitute out more cost-effective emissions reduction technologies in countries without tax.
}

\begin{frame}
  \frametitle{Impact of Overlapping Tax}
\begin{center}
\begin{figure}[h!]
\centering
\rotatebox{0}{
...
\begin{frame}
  \frametitle{Impact of Overlapping Tax by 2020}
\begin{center}
\begin{figure}[h!]
\centering
\rotatebox{0}{
...
\begin{frame}
  \frametitle{Possible Impact of Subsidies I}
\begin{center}
\begin{figure}[h!]
\centering
\rotatebox{0}{
