...
\frame{\frametitle{Valuation by Replication}
\begin{itemize}
...
\frame{\frametitle{Valuation by Replication - Idea}
\begin{itemize}
...
\frame{\frametitle{Valuation by Replication - Example (1)}
\begin{itemize}
...
\frame{\frametitle{Valuation by Replication - Example (2)}
\begin{itemize}
...
\frame{\frametitle{Valuation by Replication - Example (3)}
...
\frame{\frametitle{Valuation by Replication - Example (4)}
\begin{itemize}
...
\frame{\frametitle{Valuation by Replication - Example (5)}
\begin{itemize}
...
\frame{\frametitle{Valuation by Replication - Example (6)}
\begin{itemize}
...
\frame{\frametitle{Valuation by Replication - Example (7)}
\begin{itemize}
...
\frame{\frametitle{No-Arbitrage and Expectation (1)}
\begin{itemize}
...
\frame{\frametitle{No-Arbitrage and Expectation (2)}
\begin{itemize}
...
\frame{\frametitle{No-Arbitrage and Expectation - General Principle}
\begin{itemize}
...
\frame{\frametitle{ The Cox-Ross-Rubinstein model}
...
\frame{\frametitle{ The CRR Model}
...
\frame{\frametitle{Pricing in the CRR Model}
...
\frame{\frametitle{Pricing measure}
...
\frame{\frametitle{European claims}
\begin{itemize}
...
\frame{\frametitle{European call}
\begin{itemize}
...
\frame{\frametitle{ A Three-period Example (1)}
...
\frame{\frametitle{ A Three-period Example (2)}
\begin{itemize}
...
\frame{\frametitle{ A Three-period Example (3)}
\begin{itemize}
...
\frame{\frametitle{Delta  of an option}
\begin{itemize}
...
\frame{\frametitle{Example of the Delta}
\begin{itemize}
\item<1->
$$
...
\frame{\frametitle{Binomial Approximations (1)}
...
\frame{\frametitle{Binomial Approximations (2)}
...
\frame{\frametitle{The Black-Scholes Formula}
...
\frame{\frametitle{ American Options in the CRR model (1)}
\begin{itemize}
...
\frame{\frametitle{ American Options in the CRR model (2)}
\begin{itemize}
  \item The remaining
...
\frame{\frametitle{ American Options in the CRR model (3)}
\begin{itemize}
...
\frame{\frametitle{ American Options in the CRR model (4)}
\begin{itemize}
...
\frame{\frametitle{ American Options in the CRR model (5)}
...
\frame{\frametitle{American Options in the CRR model - Step (1)}
...
\frame{\frametitle{American Options in the CRR model - Step (2)}
\begin{enumerate}
\setcounter{enumi}{3}
...
\frame{\frametitle{American Options in the CRR model - Step (3)}
\begin{itemize}
  \item The value of
...
\frame{\frametitle{American Options in the CRR model - Step (4)}
\begin{enumerate}
\setcounter{enumi}{4}
...
\frame{\frametitle{ A Three-period Example (4)}
...
\frame{\frametitle{ A Three-period Example (5)}
...
\frame{\frametitle{ A Three-period Example (6)}
