...
\frame{\frametitle{ Heath-Jarrow-Morton (HJM) model}
...
\frame{\frametitle{One-Factor GBM Specification}
...
\frame{\frametitle{Schwartz Volatility}
...
\frame{ \frametitle{The Model Framework}
\begin{itemize}
