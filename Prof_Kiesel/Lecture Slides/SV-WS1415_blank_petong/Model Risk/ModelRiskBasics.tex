...
\frame{\frametitle{SST Classification of Risk Types}
\begin{figure}
	\centering
...
\frame{\frametitle{Deutsche Bank Risk Types}
\begin{figure}
	\centering
...
\frame{\frametitle{Deutsche Bank Annual Report 2012}
\begin{itemize}
\item<1->
...
\frame{\frametitle{Basel Regulation I}
...
\frame{\frametitle{Basel Regulation II}
\begin{itemize}
...
\frame{\frametitle{Schoutens - CallFit, NIGCIR}
\begin{figure}[htp]
\centering
...
\frame{\frametitle{Schoutens - CallFit, BNS}
\begin{figure}[htp]
\centering
...
\frame{\frametitle{Schoutens - Exotic Fit}
\begin{figure}[htp]
\centering
...
\frame{\frametitle{Schoutens - Clique Fit}
\begin{figure}[htp]
\centering
...
\frame{\frametitle{How to define model risk?}
\begin{itemize}
...
\frame{\frametitle{Derman (1996) -- Value Approach}
\begin{itemize}
...
\frame{\frametitle{Rebonato (2003) -- Price Approach}
...
\frame{\frametitle{J. Hull: Risk Management and Financial Institutions}
...
\frame{\frametitle{Hull: Model Risk}
\begin{itemize}
...
\frame{\frametitle{Bayesian Model Averaging -- Valuation}
\begin{itemize}
...
\frame{\frametitle{Worst-Case Approach}
\begin{itemize}
...
\frame{\frametitle{Convex Risk Measures}
...
\frame{\frametitle{Convex Risk Measures -- Properties}
...
\frame{\frametitle{Examples: VaR and AVaR}
\begin{itemize}
...
\frame{\frametitle{Average Value-at-Risk (AVaR) }
\begin{itemize}
...
\frame{\frametitle{Illustration of AVaR}
\begin{figure}
	\centering
...
\frame{\frametitle{Bann{\"o}r-Scherer Approach}
\begin{itemize}
...
\frame{\frametitle{Risk Capturing Functionals}
...
\frame{\frametitle{Model Risk -- Cont's Suggestion}
\begin{itemize}
...
\frame{\frametitle{Construction of Risk Capturing Functionals}
\begin{itemize}
...
\frame{\frametitle{Parameter Risk-Capturing Valuation}
\begin{center}
...
\frame{\frametitle{Definition AVaR}
\begin{itemize}
\item general probability space $(\Omega, \F, \prb)$, $\beta \in (0,1]$, $X\in L^1(\prb)$, then
$$
VaR_\beta(X) = q_{-X}^{\prb}(1-\beta).
...
\frame{\frametitle{Definition AVaR risk capturing functional}
\begin{itemize}
...
\frame{\frametitle{Convergence Property of AVaR}
\begin{itemize}
...
\frame{\frametitle{Using asymptotic distributions}
\begin{itemize}
...
\frame{\frametitle{Calculating AVaR}
\begin{itemize}
